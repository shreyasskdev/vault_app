...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -368459335;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__file__delete_dir_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__file__delete_file_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__file__get_album_thumb_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__file__get_dirs_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__file__get_file_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__file__get_file_thumb_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__file__get_images_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__file__save_file_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__file__set_password_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__file__zip_backup_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
